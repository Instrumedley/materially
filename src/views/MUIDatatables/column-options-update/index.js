        ...
        return (
            <React.Fragment>
                ...
                <Grid container spacing={gridSpacing}>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <Grid container spacing={1}>
                                    ...
                                    <Grid item>
                                        <Button variant="contained" color="primary" onClick={this.handleFilterNameChange}>
                                            Change filter names for first column!
                                        </Button>
                                    </Grid>
                                    <Grid item>
                                        <Button variant="contained" color="primary" onClick={this.handleAddData}>
                                            Add row data!
                                        </Button>
                                    </Grid>
                                    <Grid item>
                                        <Button variant="contained" color="primary" onClick={this.handleChangeDisplay}>
                    ...
                    <Grid item xs={12}>
                        <MUIDataTable title={'Column Option Update'} data={data} columns={columns} options={options} />
                    </Grid>
                </Grid>
            </React.Fragment>
        );
