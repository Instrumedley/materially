...
class Example extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Breadcrumb title="Selectable Rows">
                ...
                <MUIDataTable
                    title={
                        <React.Fragment>
                            <Typography variant="h5">Selectable Rows</Typography>
                            <Typography variant="caption">Note: Limit the number of selections to 3</Typography>
                        </React.Fragment>
                    }
