    ...
    return (
        <React.Fragment>
            <Grid container justify="center">
                <Grid item xs={12}>
                    <Button fullWidth={true} className={classes.redButton} size="large" variant="contained">
                        <img src={Google} alt="google" width="20px" className={classes.loginIcon} /> Register with Google
                    </Button>
                </Grid>
            </Grid>
