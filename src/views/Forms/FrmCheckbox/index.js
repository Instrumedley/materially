                        ...
                        <CardContent>
                            <FormGroup>
                                <Grid container spacing={1}>
                                    <Grid item>
                                        <FormControlLabel
                                            control={<Checkbox checked={state.checkedA} onChange={handleChangeState} name="checkedA" />}
                                            label="Secondary"
                                        />
                                    </Grid>
                                    <Grid item>
                                                ...
                                                <FormGroup>
                                                    <Grid container spacing={1}>
                                                        <Grid item>
                                                            <FormControlLabel
                                                                control={
                                                                    <Checkbox checked={gilad} onChange={handleChangeGroup} name="gilad" />
                                                                }
                                                                label="Gilad Gray"
                                                            />
                                                        </Grid>
                                                        <Grid item>
                                                            <FormControlLabel
                                                                control={
                                                                    <Checkbox checked={jason} onChange={handleChangeGroup} name="jason" />
                                                                }
                                                                label="Jason Killian"
                                                            />
                                                        </Grid>
