...
import { makeStyles, Card, CardHeader, CardContent, Divider, Grid, TextField, Typography } from '@material-ui/core';
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <Autocomplete
                                        ...
                                        options={top100Films.map((option) => option.title)}
                                        renderInput={(params) => (
                                            <TextField {...params} label="Free Solo" margin="normal" variant="outlined" />
                                        )}
                                    />
                                </CardContent>
                            </Card>
