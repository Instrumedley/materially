        ...
        <div className={classes.root}>
            ...
            <SwipeableViews axis={theme.direction === 'rtl' ? 'x-reverse' : 'x'} index={value} onChangeIndex={handleChangeIndex}>
                ...
                <TabPanel value={value} index={2} dir={theme.direction}>
                    ...
                    butcher vice lomo. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum
                    eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch
                    et.
                </TabPanel>
            </SwipeableViews>
        </div>
