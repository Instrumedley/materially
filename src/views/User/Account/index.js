            ...
            <div className={classes.root}>
                            ...
                            <Card>
                                ...
                                <CardContent className={classes.accountcontent}>
                                    <Grid container spacing={2}>
                                        <Grid item xs={12}>
                                            <Avatar alt="User 1" src={Avatar1} className={classes.accountavtar} />
                                        </Grid>
                                        <Grid item xs={12}>
                ...
                <TabPanel value={value} index={1}>
                    <Grid container spacing={gridSpacing}>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <BillCard
                                primarytext="Total Credits"
                                secondrytext="1570 GB"
                                    ...
                                    <Grid container spacing={gridSpacing}>
                                        <Grid item xs={12}>
                                            <Grid container spacing={1} alignItems="center">
                                                ...
                                                <Grid item xs zeroMinWidth className={classes.paymentendcontent}>
                                        ...
                                        <Grid item xs={12}>
                                            <Divider className={classes.opacity50} />
                                        </Grid>
                                        <Grid item xs={12}>
                                            <Grid container spacing={1} alignItems="center">
                                                <Grid item>
                                                ...
                                                <Grid item>
                                                    <Grid container spacing={1}>
                                                        <Grid item>
                                                            <Link href="#" color="secondary">Make Default</Link>
                                                        </Grid>
                                                        <Grid item>
                                                            <Typography variant="subtitle2" className={classes.opacity50}>
                                                                |
                        ...
                        <Grid item xs={12}>
                            <Card>
                                ...
                                <CardContent className={classes.projecttablecard}>
                                    <Table>
                                        <TableHead className={classes.usertable}>
                                            <TableRow>
