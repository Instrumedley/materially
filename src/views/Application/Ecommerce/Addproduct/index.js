    ...
    return (
        <React.Fragment>
            ...
            <div className={classes.root}>
                <Grid container alignContent="center" justify="center" spacing={gridSpacing}>
                                ...
                                <Grid container spacing={gridSpacing}>
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        <TabPanel value={value} index={1}>
                                            <Grid container spacing={gridSpacing}>
                                                <Grid item xs={12}>
                                                    <TextField id="outlined-basic6" fullWidth label="Tax Rate" variant="outlined" />
                                                </Grid>
                                                <Grid item xs={12}>
                                                    <TextField
                                                        type="number"
                                        ...
                                        <TabPanel value={value} index={2}>
                                            <Grid container spacing={gridSpacing}>
                                                ...
                                                <Grid item md={6} xs={12}>
                                                    <TextField id="outlined-basic9" fullWidth label="Weight" variant="outlined" />
                                                </Grid>
                                                <Grid item xs={12}>
                                                    <TextField
                                                        type="number"
